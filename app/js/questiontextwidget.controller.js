/**
 * @File Controller for Project Question Text Widget
 * @Author RJChow
 */

(function () {
    'use strict';
    angular.module('crams.nectar').controller('QuestionTextWidgetController', QuestionTextWidgetController);
    QuestionTextWidgetController.$inject = ['$scope', '$log', 'QuestionsService'];


    function QuestionTextWidgetController($scope, $log, QuestionsService) {
        var vm = this;
